...
/**
 * Vertex format that stores position, color, and texture coordinates.
 * 
 * @author justin
 */
public class VertexFmtPCT extends VertexFmtPC {
  ...
  /**
   * Initializes a vertex format that stores position, color, and texture coordinate data.
   * 
   ...
   */
  public VertexFmtPCT(int vertexSize, int vertexType, int colorSize, int colorType,
      int texCoordCount, int texCoordType) {
    this(vertexSize, vertexType, colorSize, colorType, new int[] { texCoordCount },
   ...
   */
  public VertexFmtPCT(int vertexSize, int vertexType, int colorSize, int colorType,
      int[] texCoordSizes, int[] texCoordTypes) {
