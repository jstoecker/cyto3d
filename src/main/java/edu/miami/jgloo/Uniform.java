...
/**
 * References a uniform variable used in a shader. Values wrapped in these objects are stored
 * locally in RAM; they must be copied to the shader program when the program is active and the
 * OpenGL context is current.
 * <p>
 * Creating a uniform variable requires the OpenGL context to be current and the shader program to
 * be active, as well.
 * 
 * @author justin
 */
public abstract class Uniform {
  ...
  /**
   * Updates the value in the actual shader program, requiring a current GL context and the program
   * to be enabled
   */
  ...
  public static class Mat4 extends Uniform {
    ...
    public Mat4(GL2 gl, ShaderProgram prog, String name, edu.miami.math.vector.Mat4 m) {
      super(gl, prog, name);
      setValue(gl, m.wrap());
    }
    ...
    /** Sets the value and updates it in the shader program */
    public void setValue(GL2 gl, edu.miami.math.vector.Mat4 m) {
      this.matrix = m.wrap();
      update(gl);
    }

    /** Sets the locally stored value */
    public void setValue(edu.miami.math.vector.Mat4 m) {
      this.matrix = m.wrap();
    }
  }
  ...
  public static class Vec2 extends Uniform {
    ...
    public Vec2(GL2 gl, ShaderProgram prog, String name, edu.miami.math.vector.Vec2 value) {
      super(gl, prog, name);
      setValue(gl, value);
    }
    ...
    /** Sets the value and updates it in the shader program */
    public void setValue(GL2 gl, edu.miami.math.vector.Vec2 v) {
      System.arraycopy(v.values(), 0, value, 0, 2);
      update(gl);
    }
    ...
    /** Sets the locally stored value */
    public void setValue(edu.miami.math.vector.Vec2 v) {
      System.arraycopy(v.values(), 0, value, 0, 2);
    }
  ...
  public static class Vec3 extends Uniform {
    ...
    public Vec3(GL2 gl, ShaderProgram prog, String name, edu.miami.math.vector.Vec3 value) {
      super(gl, prog, name);
      setValue(gl, value);
    }
    ...
    /** Sets the value and updates it in the shader program */
    public void setValue(GL2 gl, edu.miami.math.vector.Vec3 v) {
      System.arraycopy(v.values(), 0, value, 0, 3);
      update(gl);
    }
    ...
    /** Sets the locally stored value */
    public void setValue(edu.miami.math.vector.Vec3 v) {
      System.arraycopy(v.values(), 0, value, 0, 3);
    }
  ...
  public static class Vec4 extends Uniform {
    ...
    public Vec4(GL2 gl, ShaderProgram prog, String name, edu.miami.math.vector.Vec4 value) {
      super(gl, prog, name);
      setValue(gl, value);
    }
    ...
    /** Sets the value and updates it in the shader program */
    public void setValue(GL2 gl, edu.miami.math.vector.Vec4 v) {
      System.arraycopy(v.values(), 0, value, 0, 4);
      update(gl);
    }
    ...
    /** Sets the locally stored value */
    public void setValue(edu.miami.math.vector.Vec4 v) {
      System.arraycopy(v.values(), 0, value, 0, 4);
    }
