...
/**
 * Data structure used to store information necessary for lighting. This class does not correspond
 * to an OpenGL fixed-function light; that is, modifying its members will not have an effect on the
 * current scene's lighting. The purpose of this class is to consolidate lighting attributes in one
 * structure. There are also some utility methods to apply the stored values to a specified OpenGL
 * light.
 * 
...
public abstract class Light {
   ...
   * @param light - id of the light (ex. GL_LIGHT0)
   */
