...
public class SpotLight extends PointLight {
  ...
  public void setSpotDirection(Vec3 dir) {
  ...
  public void setSpotCutoff(float c) {
    spotCutoff = GMath.clamp(c, MIN_CUTOFF, MAX_CUTOFF);
  }
  ...
  public void setSpotExponent(float e) {
    spotExponent = GMath.clamp(e, MIN_EXPONENT, MAX_EXPONENT);
  }
  ...
  /** Creates a new spotlight. */
  public SpotLight(Vec3 pos, Vec3 dir, float cutoff) {
    this(pos, dir);
    this.spotCutoff = cutoff;
  }

  /** Creates a new spotlight. */
  public SpotLight(Vec3 pos, Vec3 dir, float cutoff, float exponent) {
    this(pos, dir, cutoff);
