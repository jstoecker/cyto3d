...
/**
 * A buffer used to store vertex and pixel data in video memory. Allows pixel data transfer through
 * direct memory access to improve performance of read/write operations.
 * 
...
public class PixelBufferObject implements GLDisposable {
   ...
   * @param data - data to store into PBO
   * @param dataSize - size of data in bytes
   * @param pack - if true, data is transferred from OpenGL to app (read); otherwise, data is
   *          transferred from app to OpenGL (unpack / upload)
  ...
  public void finalize() {
    if (!disposed) System.err.printf("WARNING: PBO %d was not disposed!\n", id);
  }
}
